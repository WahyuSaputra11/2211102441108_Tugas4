...
public class Character extends Actor
{
    ...
    public void act() 
    {
        ...
        MyWorld myw1 = (MyWorld)getWorld();
        getWorld().showText("Score : "+myw1.getSkorFrog(),50,25);
        getWorld().showText("Live : "+myw1.getNyawaFrog(),150,25);
    ...
    public void movePlayer(){
        ...
        Actor ObjectSpecial = getOneObjectAtOffset(adjustedChangeX, adjustedChangeY, ObjectSpecial.class);
